...
$card->save();
$card_id = mysqli_insert_id($database->connection);
            ...
            <div class="payment">
              ...
              <form method="POST" class="form">
                ...
                <div class="form__name form__detail">
                  ...
                  <input type="text" name="name" placeholder="" id="name" maxlength="24">
                ...
                <div class="form__number form__detail">
                  ...
                  <input name="card_number" type="text" name="" placeholder="0000 0000 0000 0000" id="number" onkeypress="return isNumeric(event)">
                ...
                <div class="form__expiry form__detail">
                  ...
                  <input name="expiry" type="text" placeholder="MM/YY" id="date" onkeypress="return isNumeric(event)" >
