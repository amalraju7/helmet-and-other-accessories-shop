        ...
        <tr class="cart-product">
         ...
         echo "admin/images/" . $images[1]; ?>" alt=""></div>
            ...
            <?php if($variant->quantity > 0){ ?>
                ...
                <td class="cart-product__quantity"><form  action="cart.php?variant=<?php echo $variant->id; ?>" method="POST"><input type="number" min="1" max="<?php echo $variant->quantity; ?>" name="quantity" value="<?php echo $cart->quantity; ?>"> <input name="update" value="update" type="submit"> </form></td>
            <?php } else {  ?>
