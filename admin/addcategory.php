          ...
          <h4 class="bg-danger"><?php echo $session->message; ?></h4>
			<div id="admin-index-form">
				...
				<label for="category_title_id">Category Name : </label>
					 ...
					 <input required value="<?php if(isset($_POST['submit'])){ echo  $category->name; } ?>" type="text" id="category_title_id" name="category_name" class="form-control" ><br>
				
					 
					

					<label for="category_description_id">Category Description : </label>
					<textarea name="category_description" class="form-control" id="category_description_id" rows="7"><?php if(isset($_POST['submit'])){ echo  $category->description; } ?></textarea><br>
