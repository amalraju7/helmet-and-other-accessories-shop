	...
	{ 
	    ...
	    {             
            ...
            buttons: [      
                {
                    extend: 'excelHtml5',
                    title: '<?php echo "Customer Order Report {$_POST['from']} - {$_POST['to']} " ?>',
...
?>
<h1>Customer Order Report From <?php echo $from; ?> To <?php echo $to; ?> </h1>
                <table id="example" class="display nowrap mx-3">
                    <thead>
                        ...
                        <tbody>
                            <?php
                        $sql = "SELECT Sum(total_amount), cust_id  FROM `order_master` WHERE id = $main GROUP BY cust_id";
                        ...
                        <tr>
                           ...
                           <td><?php $user = User::find_by_id($row[1]);
                           ...
                           echo mysqli_affected_rows($database->connection); ?></td>
                           <td><?php 
                              $sql ="SELECT * FROM order_master where cust_id = $user->id";
                              $c = Order_master::find_by_query($sql);
