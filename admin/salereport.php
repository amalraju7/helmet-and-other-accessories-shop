	...
	{ 
	    ...
	    {             
            ...
            buttons: [      
                {
                    extend: 'excelHtml5',
                    title: '<?php echo "Mactanse: Sales Report {$_POST['from']} - {$_POST['to']} " ?>',
                    text:'Download as Excel' 
                },
                {
                    extend: 'csvHtml5',
                    title: '<?php echo "Mactanse: {$_POST['from']} - {$_POST['to']} " ?>',                 
...
?>
<h1>Sales Report From <?php echo $from; ?> To <?php echo $to; ?> </h1>
                <table id="example" class="display nowrap mx-3">
                    ...
                    <th>Vendor</th>
                        ...
                        <tbody>
                            <?php
                        $sql = "SELECT Sum(quantity), item_id  FROM `order_child` WHERE master_id = $main GROUP BY item_id";
                        ...
                        <tr>
                          ...
                          echo $v->name; ?></td>
                            ...
                            <td><?php 
                            $sql="SELECT * FROM order_child WHERE item_id= '{$row[1]}' ";
                            $pms = Order_child::find_by_query($sql);
                            $total = 0;
                            foreach($pms as $pm){
