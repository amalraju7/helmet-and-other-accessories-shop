	...
	{ 
	    ...
	    {             
            ...
            buttons: [      
                {
                    extend: 'excelHtml5',
                    title: '<?php echo "Customer Report {$_POST['from']} - {$_POST['to']} " ?>',
...
?>
<h1>Customer Report From <?php echo $from; ?> To <?php echo $to; ?> </h1>
                <table id="example" class="display nowrap mx-3">
                    <thead>
                        ...
                        <tbody>
                            <?php
                        $sql = "SELECT *  FROM `users` WHERE (id = $main) AND user_type='customer' ";
