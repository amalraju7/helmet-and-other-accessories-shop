	...
	{ 
	    ...
	    {             
            ...
            buttons: [      
                {
                    extend: 'excelHtml5',
                    title: '<?php echo "Mactanse: Vendor Report {$_POST['from']} - {$_POST['to']} " ?>',
...
?>
<h1>Vendor Report From <?php echo $from; ?> To <?php echo $to; ?> </h1>
                <table id="example" class="display nowrap mx-3">
                    ...
                    <th>Vendor Phone </th>
                        ...
                        <tbody>
                            <?php
                        $sql = "SELECT Sum(total_amount), vendor_id  FROM `purchase_master` WHERE id = $main GROUP BY vendor_id";
                        ...
                        <tr>
                            <td><?php echo $s; ?></td>
                            <td><?php
                            $vendor= Vendor::find_by_id($row[1]);
