...
<html>
    ...
    <?php
                  ...
                  $card = Card::find_by_id($u->card_id);
            ...
            <div class="payment">
              ...
              <div class="card">
                ...
                <div class="card__number"><?php echo $card->card_number; ?></div>
                ...
                <div class="card__expiry">
                  ...
                  <p>
                      ...
                      ?>
                    <span id="month"><?php echo $expiry[0]; ?></span>/<span id="year"><?php echo $expiry[1]; ?></span>
                  </p>
                  </div>
                  </div>
          <?php if(isset($_GET['status'])){ ?>
              <form method="POST" action="Third.php?status=buy" class="form">
          <?php  } else { ?> <form method="POST" action="Third.php" class="form"> <?php } ?>
                <h2>Payment Details</h2>
                
                <div class="form__name form__detail">
                  <label for="name">Cardholder Name</label>
                  <ion-icon name="person-outline"></ion-icon>
                  <input type="text" value="<?php echo $card->name; ?>" name="name" placeholder="" id="name" maxlength="24">
                ...
                <div class="form__number form__detail">
                  ...
                  <input name="card_number"  value="<?php echo $card->card_number; ?>"  type="text" name="" placeholder="0000 0000 0000 0000" id="number" onkeypress="return isNumeric(event)">
                ...
                <div class="form__expiry form__detail">
                  ...
                  <input name="expiry" type="text" value="<?php echo $card->expiry; ?>"  placeholder="MM/YY" id="date" onkeypress="return isNumeric(event)" >
                ...
                <button type="submit" name="submit" class="form__btn">Confirm</button>
